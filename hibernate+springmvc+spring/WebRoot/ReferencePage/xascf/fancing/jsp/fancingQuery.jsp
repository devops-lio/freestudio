...
<script type="text/javascript" src="xascf/fancing/js/fancingQuery.js"></script>
<style>
</style>
      ...
      <div class="widget-body">
          <div class="widget-form">
              <div class="form-toolbar">
					<a class="btn btn-primary" href="javascript:void(0)" id="queryBtn" onclick="javascript:FancingQuery.query();"><i class=""></i>查询<br /></a>
					<a class="btn btn-primary" href="javascript:void(0)" onclick="javascript:FancingQuery.clear();"><i class=""></i>重置<br /></a>
			  </div>
