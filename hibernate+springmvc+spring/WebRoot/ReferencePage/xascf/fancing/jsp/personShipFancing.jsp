...
<script type="text/javascript" src="xascf/fancing/js/personFancingEdit.js"></script>	
		...
		<div class="widget-form">
	 		<form class="form-horizontal" id="fancingForm">
	 			<div class="row-fluid">
	 					<div class="span3 control-group full ">
			              ...
			              <div class="controls txt">
			                ...
			                <input type="hidden" name="fancingOrderEntity.fancingOrderItem.fancingRequestType" value="2" id="requestType">
	 					...
	 					<div class="span3 control-group full">
			              <label class="control-label" for="">申请人<span style="color: red;">*</span></label>
	 			...
	 			<div class="row-fluid">
		 			...
		 			以下请选择您提供融资的材料，以便我们做出评估，谢谢!
			 		</div>
					 <div class="row-fluid" style="margin-top: 5px;font-size: 14px;">
				 					<!-- 个人基本材料jsp -->
	 					<jsp:include page="personRootMaterialInfo.jsp"></jsp:include>
			 		</div>
					 <div class="row-fluid" style="margin-top: 5px;font-size: 14px;">
				 					<!-- 采购商jsp -->
		 		...
		 		<div class="row-fluid offset4" style="margin-top: 20px;margin-bottom: 30px;width: 62%">
					      <a class="btn btn-primary" href="javascript:void(0)" onclick="PersonFancingEdit.save()"><i class=""></i>保存</a> 
					      <a class="btn btn-primary" href="javascript:void(0)" onclick="PersonFancingEdit.comfirFancingOrder()"><i class=""></i>提交</a> 
					      <a id="edit" class="btn btn-primary" href="javascript:void(0)" onclick="PersonFancingEdit.edit()"><i class=""></i>返回</a> 
		 		</div>
