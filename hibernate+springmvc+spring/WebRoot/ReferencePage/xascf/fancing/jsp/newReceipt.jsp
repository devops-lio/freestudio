...
<script type="text/javascript" src="xascf/fancing/js/newReceipt.js"></script>
<style>
</style>
      ...
      <div class="widget-body">
          <div class="widget-form">
              <div class="form-toolbar">
					<a class="btn btn-primary" href="javascript:void(0)" id="queryBtn" onclick="javascript:ReceiptManager.query();">查询</a>
					<a class="btn btn-primary" href="javascript:void(0)" onclick="javascript:ReceiptManager.clear();">重置</a>
			  </div>
