...
<script type="text/javascript" src="xascf/customer/js/companyPurchase.js"></script> 
<%
	pageContext.setAttribute("basicDataModelList", 
	com.sinoservices.xascf.utils.DataConfigUtil.getDataByParentCode("PURCHASE_CATEGORY"));
	%>
<div class="widget-box">
	<div class="widget-header">
		<span class="widget-title"><i class="icon-search"></i>委托方登记查询</span> 
		<span class="widget-toolbar"><a href="#" data-action="collapse"><i class="icon-chevron-up"></i></a></span>
	</div>
	<div class="widget-body">
		<div class="widget-form">
			<div class="form-toolbar">
				<a class="btn btn-primary" onclick="CompanyPurchase.load();">查询</a>
				<a class="btn btn-primary" onclick="CompanyPurchase.clear();">重置</a>
			</div>
			<form class="form-horizontal fromPre" id="purchaseSearchForm"> 
				<div class="row-fluid "> 
					...
					<div class="span3 control-group full">
		                ...
		                <div class="controls txt"> 
								<select name="condition.businessScope" class="chzn-select"  data-placeholder="请选择">
										<option value=""></option>
...
<div class="widget-box">
	<div class="widget-header">
		<span class="widget-title"><i class="icon-list"></i>委托方登记列表</span>
        <span class="widget-toolbar"><a href="#" data-action="collapse"><i class="icon-chevron-up"></i></a></span>
	</div>
	<div class="widget-body">
		<div class="widget-grid">
		    <div class="grid-toolbar">  
                <a class="btn btn-primary" onclick="CompanyPurchase.add();">新增</a>
                <a class="btn btn-primary" onclick="CompanyPurchase.update();">编辑</a> 
                <a class="btn btn-primary" onclick="CompanyPurchase._delete();">删除</a> 
            </div>
			<!-- mmGrid -->
...
<script id="template_weitf" type="text/x-handlebars-template"> 
	...
	<div class="form-search" style="font-size: 13px;">
	    ...
	    <div class="form-search-btn">
	        <a class="btn btn-primary save" href="javascript:void(0)" onclick="CompanyPurchase.save()"><i class=""></i>保存</a>
	        <a class="btn btn-primary save" href="javascript:void(0)" onclick="CompanyPurchase.canclePurchase()"><i class=""></i>取消</a>
	    </div>
	</div>  
</script>
