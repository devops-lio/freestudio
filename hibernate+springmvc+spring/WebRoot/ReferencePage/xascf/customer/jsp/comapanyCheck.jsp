...
<script type="text/javascript" src="xascf/customer/js/comapanyCheck.js"></script>
<style>
...
<div class="widget-box" style="font-size: 12px;">
	...
	<div class="widget-body" style="font-size: 12px;margin-bottom: -5px;border-bottom: 1px solid #ccc;" id="approdPassDiv">
		...
		<input type="hidden" name="approval.approvalBussnessNo"	value="${comInModel.memberNo }">
		<input type="hidden" name="approval.approvalStatus"	value="${comInModel.customerStatus }">
			<input type="hidden"  name="approval.objectPid"		value="${comInModel.memberPid }">
			<div class="row-fluid">
				<div class="row-fluid">
					<div class="span3 control-group full">
			...
			<div class="row-fluid offset4"
					...
					<a class="btn btn-primary" href="javascript:void(0)" onclick="ComapanyCheck.save()"><i class=""></i>保存审批</a>
					<a class="btn btn-primary" href="javascript:void(0)" onclick="ComapanyCheck.returnBackList()"><i class=""></i>返回列表</a>
			</div>
		</form>
	</div>
</div>
