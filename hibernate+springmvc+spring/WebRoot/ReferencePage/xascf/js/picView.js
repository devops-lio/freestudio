            ...
            _this.change(function() {
                ...
                if (this.value) {
                    if (!RegExp("\.(" + opts.imgType.join("|") + ")$", "i").test(this.value.toLowerCase())) {
                        PUI.MessageBox.info("图片类型必须是" + opts.imgType.join("，") + "中的一种");
                        this.value = "";
                        ...
                        if (version == 6) {
                            ...
                            image.onload = function(){
                                if( (image.fileSize/1024) > opts.maxSize) {
                                	PUI.MessageBox.info('图片大小不能超过'+opts.maxSize+'K');
                                	return false;
                                }
                            }
