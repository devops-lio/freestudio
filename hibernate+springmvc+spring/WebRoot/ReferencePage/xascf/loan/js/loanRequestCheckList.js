 ...
 var ch_cols = [
       { title:'放款单号', name:'fancingOrderItem' ,width:100, align:'center', sortable: true, type: 'object',
	    ...
	    { title:'操作', name:'' ,width:40, align:'center', sortable: true, type: 'String',
 			  ...
 			  return '<a class="btnPrice" href="javascript:void(0)" onclick="LoanRequestCheck.fancingCheck(\''+orderNo+'\')">审批</a>';
	 	 }}, 
	    { title:'会员名称', name:'fancingOrderItem' ,width:250, align:'left', sortable: true, type: 'object',
	  ...
	  { title:'委托方名称', name:'fancingOrderItem' ,width:220, align:'left', sortable: true, type: 'object',
        ...
        { title:'批复金额', name:'fancingOrderItem' ,width:100, align:'center', sortable: true, type: 'object',
	        	renderer: function(val){return formatMoney(val.replyPrice)+' 元'}},
    	 { title:'预计回款日', name:'fancingOrderItem' ,width:100, align:'center', sortable: true, type: 'object',
            renderer: function(val){
            	return val.termDate;
            }
        } 	
...
var	waitCheck_mmg =  $("#waitCheck_mmg").mmGrid({
		...
		cols : ch_cols,
		url : 'xascf/fancing/page.shtml?type=ZRWAITCHECK',
...
var LoanRequestCheck = function() {
	return {
		...
		fancingCheck :function (orderNo){
			$.post("xascf/fancing/toZRCheck.shtml",{orderNo:orderNo},function(data){  
