 ...
 var ch_cols = [
       { title:'放款单号', name:'fancingOrderItem' ,width:120, align:'center', sortable: true, type: 'object',
	    ...
	    { title:'操作', name:'' ,width:40, align:'center', sortable: true, type: 'String',
			  ...
			  return '<a class="btnPrice" href="javascript:void(0)" onclick="LoanRequestFXWYHCheck.fancingCheck(\''+orderNo+'\')">审批</a>';
	 	 }},
...
var	waitCheck_mmg =  $("#waitCheck_mmg").mmGrid({
		...
		cols : ch_cols,
		url : 'xascf/fancing/page.shtml?type=FXWYHAITCHECK',
...
var LoanRequestFXWYHCheck = function() {
	return {
		...
		fancingCheck :function (orderNo){
			$.post("xascf/fancing/toFXWYHCheck.shtml",{orderNo:orderNo},function(data){  
