...
<script type="text/javascript"	src="xascf/loan/js/balancePaymentEdit.js"></script>
					...
					<div class="widget-form" style="padding: 0px;border-bottom: 1px #ccc solid;">
							<div class="widget-box" style="margin-top:0px;">
								<div class="widget-header" style="background-color: #438eb9;">
									<span class="widget-title"><i class="icon-list"></i>尾款申请信息
								...
								<div class="widget-body" >
									<form class="form-horizontal fromPre" id="fancingForm">
										<div class="row-fluid"
											...
											<div class="row-fluid">
												<div class="span3 control-group full">
													...
													<div class="controls xwin">
														<input type="hidden"
															name="fancingOrderEntity.fancingOrderItem.menberPid"
															id="memberPid"
															value="${fancingOrderEntity.fancingOrderItem.menberPid }">
														<input type="hidden"
															name="fancingOrderEntity.fancingOrderItem.pid"
															id="fancingPid"
															value="${fancingOrderEntity.fancingOrderItem.pid }">
														<input type="hidden"
															name="fancingOrderEntity.fancingOrderItem.menberType"
															value="1">
														<input type="hidden"
															name="fancingOrderEntity.fancingOrderItem.fancingFrom"
															value="1">
														<input type="hidden"
															name="fancingOrderEntity.fancingOrderItem.creditNo"
															id="creditNo"
															value="${fancingOrderEntity.fancingOrderItem.creditNo }"
															>
														<input type="hidden"
												...
												<div class="span3 control-group full" style="margin-left: 120px;">
													<label class="control-label" for="">预付放款单号</label>
													<div class="controls">
														<input type="text"  readonly="readonly" id="parentOrderNo"
															name="fancingOrderEntity.fancingOrderItem.parentOrderNo" 
															value="${fancingOrderEntity.fancingOrderItem.parentOrderNo }">
													</div>
												</div>	
												</div>
											<div class="row-fluid">
												<div class="span3 control-group full" >
													<label class="control-label" for="">委托方 </label>
													<div class="controls xwin">
														<input type="hidden"
															name="fancingOrderEntity.fancingOrderItem.buyerPid"
															id="buyerPid"
															value="${fancingOrderEntity.fancingOrderItem.buyerPid }">
														<input type="text" id="buyerName" readonly="readonly"
												...
												<div class="span3 control-group full" style="margin-left: 120px;">
													<label class="control-label" for="">批复总金额</label>
													<div class="controls">
														<input type="text"  readonly="readonly" id="requestReplyPrice"
															name="fancingOrderEntity.fancingOrderItem.requestReplyPrice" 
															value="${fancingOrderEntity.fancingOrderItem.requestReplyPrice }">
													</div>
												</div>		
											...
											<div class="row-fluid">
											<div class="span3 control-group full" >
													<label class="control-label" for="">已放金额</label>
													<div class="controls">
														<input type="text"  readonly="readonly" id="prepayPrice"
															name="fancingOrderEntity.fancingOrderItem.prepayPrice" 
															value="${fancingOrderEntity.fancingOrderItem.prepayPrice }">
													</div>
												</div>
											<div class="span3 control-group full" style="margin-left: 120px;">
													<label class="control-label" for="">未放金额</label>
													<div class="controls">
														<input type="text" readonly="readonly" id="lostPrice"
															name="fancingOrderEntity.fancingOrderItem.lostPrice"
															value="${fancingOrderEntity.fancingOrderItem.requestReplyPrice-fancingOrderEntity.fancingOrderItem.prepayPrice }">
													</div>
												</div>
												<div class="span3 control-group full " style="margin-left: 120px;">
													<label class="control-label" for=""><span
													...
													<div class="controls txt">
														<input type="text" id="replyPrice" 
															data-required="申请金额不能为空！"	data-number="只能填入数字"
															name="fancingOrderEntity.fancingOrderItem.replyPrice"
															value="${fancingOrderEntity.fancingOrderItem.replyPrice }">
														<input type="hidden" id="requestPrice"
											...
											<div class="row-fluid">
												<div class="span3 control-group full ">
													...
													<div class="controls time">
														<input type="text"
															name="fancingOrderEntity.fancingOrderItem.requestPayTime"
						...
						<div class="row-fluid">
							...
							<c:choose>
								<c:when test="${isSpecial=='1' }">
									<a class="btn btn-primary" href="javascript:void(0)" onclick="BalancePaymentEdit.save()"><i class=""></i>保存</a>
								</c:when>
								<c:otherwise>
									<a class="btn btn-primary" href="javascript:void(0)" onclick="BalancePaymentEdit.save()"><i class=""></i>保存</a>
									<a class="btn btn-primary" href="javascript:void(0)" onclick="BalancePaymentEdit.confir()"><i class=""></i>提交</a>
								</c:otherwise>
							</c:choose>
							</div>
						</div>
