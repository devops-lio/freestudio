...
<script type="text/javascript" src="xascf/loan/js/depositList.js"></script>
 ...
 <div class="widget-box">
      ...
      <div class="widget-body">
          <div class="widget-form">
			...
			<form action="" id="depositQueryForm" class="form-horizontal fromPre">
				<div class="row-fluid">
...
<div class="widget-box">
<div class="widget-header">
		<span class="widget-title"><i class="icon-list"></i>保证金列表</span>
        <span class="widget-toolbar"><a href="#" data-action="collapse"><i class="icon-chevron-up"></i></a></span>
	</div>
   <div class="widget-body">
