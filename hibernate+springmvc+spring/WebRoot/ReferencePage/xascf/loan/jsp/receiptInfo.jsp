...
<script type="text/javascript" src="xascf/loan/js/receiptInfo.js"></script>	
	<div class="widget-box">
	  <div class="widget-body">
		<div class="widget-grid">
			<div class="grid-toolbar">
		      <a class="btn btn-primary" href="javascript:void(0)" onclick="ReceiptInfo.receipt_add()"><i class=""></i>新增</a> 
		      <a class="btn btn-primary" href="javascript:void(0)" onclick="ReceiptInfo.editReceipt()"><i class=""></i>编辑</a> 
		      <a class="btn btn-primary" href="javascript:void(0)" onclick="ReceiptInfo.removeReceiptItem()" ><i class=""></i>删除</a> 
			</div>
				<table id="receipt_mmg" class="mmg">
				   ...
				   发票价税合计(元)：<span style="color: red;" id="receiptPices"></span> 
				  	&nbsp; 	 折扣后价税合计(元)：<span style="color: red;" id="receiptDisount"></span>
...
<script id="template_receipt" type="text/x-handlebars-template">
    <div class="form-search">
							...
							<div class="row-fluid">
								<div class="span5 control-group full">
									...
									<div class="controls">
										...
										<select data-placeholder="请选择..." onchange="ReceiptInfo.consigneeChange()"  
								...
								<div class="span5 control-group full">
	                				...
	                				<div class="controls" style="width:450px;">
	                  					<input type='button'  value='上传' class='btn' style="background-  color:#FFF; border:1px solid #CDCDCD;height:24px; width:56px;"
												onclick="javascript:ReceiptInfo.addUploadPop()" />
	                				</div>
	           					</div>
							</div>
	    ...
	    <div class="form-search-btn">
	        <a class="btn btn-primary" href="javascript:void(0)" onclick="ReceiptInfo.addReceiptRow()"><i class=""></i>确定</a>
	        <a class="btn btn-primary" href="javascript:void(0)" onclick="ReceiptInfo.receiptCancle()"><i class=""></i>取消</a>
	    </div>
	</div>
</script>
