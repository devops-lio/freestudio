...
<script type="text/javascript" src="xascf/loan/js/balancePaymentList.js"></script>
<style>
</style>
    ...
    <div class="widget-body">
    	<div class="widget-form">
        	<div class="form-toolbar">
				<a class="btn btn-primary" href="javascript:void(0)" id="queryBtn" onclick="javascript:BalancePaymentList.query();">查询<br /></a>
				<a class="btn btn-primary" href="javascript:void(0)" onclick="javascript:BalancePaymentList.clear();">重置<br /></a>
			</div>
...
<div class="widget-box">
<div class="widget-header">
		<span class="widget-title"><i class="icon-list"></i>已放预付款列表</span>
        <span class="widget-toolbar"><a href="#" data-action="collapse"><i class="icon-chevron-up"></i></a></span>
	</div>
    <div class="widget-body">
  		<div class="widget-grid">
			<div class="widget-body" style="border-top: none;" >
				<table id="balancePayment_mmg" class="mmg" >
					<tr>
						<th rowspan="" colspan=""></th>
					</tr>
				</table>
				<div id="balancePayment_pg" style="text-align: right;"></div>
			</div>	
		</div>
	</div>
</div>
