	...
	<div class="widget-body"
		...
		<table class="table table-bordered" id="buyerTable">
			<tr>
				...
				<th style="text-align: center;width:100px">附加材料</th>
			</tr>
			<c:forEach items="${contractEntity.contractbuyRelItemList}" var="item">
				<tr>
					...
					<td style="text-align: center;"><a href="#" onclick="contractBuyMaterial('${item.buyPid }','${contractEntity.fancingContractItem.pid }');">详情</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
