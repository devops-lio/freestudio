...
<script type="text/javascript" src="xascf/credit/js/contractQuery.js"></script>  
	...
	<div class="widget-body">
		<div class="widget-form">
			<div class="form-toolbar">
				<a class="btn btn-primary" onclick="ContractQuery.query();">查询</a>
				<a class="btn btn-primary" onclick="ContractQuery.clear();">重置</a>
			</div>
