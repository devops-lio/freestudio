...
<script type="text/javascript" src="xascf/credit/js/creditConfirList.js"></script>
<style>
</style>
<%
//产品类型
	...
	<div class="widget-body">
		<div class="widget-form">
			<div class="form-toolbar">
				<a class="btn btn-primary" onclick="creditConfirList.query();">查询</a>
				<a class="btn btn-primary" onclick="creditConfirList.clear();">重置</a>
			</div>
			<form class="form-horizontal fromPre" id="creditConfirQueryForm">
				<div class="row-fluid ">
...
<div class="widget-box">
	<div class="widget-header">
		<span class="widget-title"><i class="icon-list"></i>授信确认列表</span>
        <span class="widget-toolbar"><a href="#" data-action="collapse"><i class="icon-chevron-up"></i></a></span>
	</div>
   <div class="widget-body">
