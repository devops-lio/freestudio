...
<script type="text/javascript" src="xascf/credit/js/creditAllList.js"></script>
	...
	<div class="widget-body">
		<div class="widget-form">
			<div class="form-toolbar">
				<a class="btn btn-primary" onclick="creditAllList.query();">查询</a>
				<a class="btn btn-primary" onclick="creditAllList.clear();">重置</a>
			</div>
			<form class="form-horizontal fromPre" id="creditAllQueryForm">
				<div class="row-fluid ">
				...
				<div class="span3 control-group full">
					...
					<div class="span3 control-group full">
						...
						<div class="controls">
							<slt:select cssClass="chzn-select"
								name="condition.financingNature"
								optionsType="FANCING_KINDS">
								<slt:outHTML>id="financingNature"</slt:outHTML>
								<slt:outHTML>data-placeholder="请选择" </slt:outHTML>
							</slt:select>
						</div>
					</div>
...
<div class="widget-box">
	<div class="widget-header">
		<span class="widget-title"><i class="icon-list"></i>授信综合查询列表</span>
        <span class="widget-toolbar"><a href="#" data-action="collapse"><i class="icon-chevron-up"></i></a></span>
	</div>
   <div class="widget-body">
