...
var _mmg =  $("#mmg").mmGrid({
	...
	cols : _cols,
	url : 'xascf/information/noticeInfo/getPicInfoList.shtml',
	params : $("#PicInfoListQueryForm").serialize(),
	method : 'post',
	checkCol : true,
	indexColWidth : 15,
	autoLoad : true,
...
var picInfoList = function() {
	return {
		/**查询*/
		query : function() {
            _mmg.load($("#PicInfoListQueryForm").serialize());
		},
		...
		/**新增跳转至发布页面*/
		add : function() {
			$.post("xascf/information/noticeInfo/toEditPic.shtml",{noticePid:""}, function(data) {
				$("#xascfMainPanel").empty();
				$("#xascfMainPanel").append(data);
			});
		},
		...
		edit : function(){
			...
			$.post("xascf/information/noticeInfo/toEditPic.shtml",{noticePid:item.noticePid},function(data){
					$("#xascfMainPanel").empty();
					$("#xascfMainPanel").append(data);
			});
		},
		...
		*/
		...
		/**清空**/
		clear : function(){
			PUI.util.resetForm($("#PicInfoListQueryForm"));
		}
	};
}();